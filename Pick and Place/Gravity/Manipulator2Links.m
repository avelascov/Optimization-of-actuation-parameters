...
I1 = m*((l1/2)^2+(l/2)^2)/12 ;
I2 = m*((l/2)^2+(l2/2)^2)/12 ;
...
M = m*(Jv1).'*Jv1 + m*(Jv2).'*Jv2 +  I;

C = [-m*l1*l2/2*sin(q2)*dq2  -m*l1*l2/2*sin(q2)*(dq1+dq2); m*l1*l2/2*sin(q2)*dq1  0];
G = [(m*l1/2+m*l1)*g*cos(q1)+m*l2/2*g*cos(q1+q2) ;  m*l2/2*g*cos(q1+q2)];
