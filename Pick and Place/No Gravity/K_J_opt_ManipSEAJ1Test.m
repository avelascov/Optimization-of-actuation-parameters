...
%                         JK = JKminPEA(in);
                        JK = JKmin_SEAJ1(in); % calls function that calculates J* and K*
                        JtotK(:, i)=JK(1,:)';
...
save('1_SEAJ1_exp', 'mapp1','mapp2')

save('1_motorpos_exp', 'theta1_num','theta2_num', 'Y')
